...
-- [[ Rework of the Below Events Being Called ]] --
RegisterNetEvent('LENT-GovernmentJob:Client:PopulateVehicleList', function()
...
RegisterNetEvent('LENT-GovernmentJob:Client:CreateRequestedVehicle', function(data)
